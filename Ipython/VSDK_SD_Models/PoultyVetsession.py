...
#     disease = models.CharField(max_length=20, name='diagnosed_disease')
#
#     class Meta:
#         verbose_name = _('Call Session PoultryVet ')
#
#     def __str__(self):
...
#         return self
#
#     def record_disease(self):
#         disease_dict = {16: "Bursal Disease", 17: "Fowl Pox", 18: "Marek's Disease", 19: "Newcastle Disease"}
#         if _visted_element in disease_dict.keys():
#             disease_diagnosed = disease_dict[_visited_element]
#         self.disease = disease_diagnosed
#         self.save()
#         disease_diagnosed.save()
#         return
#
#
# class CallSessionStep2(models.Model):
#     time = models.DateTimeField(_('Time'),auto_now_add = True)
#     session = models.ForeignKey(CallSession2, on_delete = models.CASCADE, related_name = "steps")
...
#
#
# def lookup_or_create_session2(voice_service, session_id=None, caller_id = None):
#     if session_id:
